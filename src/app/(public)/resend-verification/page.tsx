...
import { resendVerification } from "@/actions/email-verification";
          ...
          {success ? (
            <div className="text-center">
              ...
              <p className="text-sm text-slate-400 mb-8">
                If an account exists with that email and hasn&apos;t been verified yet, we&apos;ve sent a new verification link. Please check your inbox and spam folder.
              </p>
              <Link
                href="/login"
